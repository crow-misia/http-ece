...
func TestDecryptWithAESGCM(t *testing.T) {
	...
	content := d(t, "vOjpVgZE4IYn/uEJKk3DzZ4X+Qr1dgSSUkuIzQE=")
...
func TestDecryptWithAESGCM_NoAuthSecret(t *testing.T) {
	...
	privateKey := d(t, "yfSYB+/vCEoWklHCG7F99cQ1vRwemFYn87jZc8PHBwU=")
	senderPublicKey := d(t, "BGJXZ4zDA04RfSgTufdauZXcNYbe3oF/yEri5ETSuZLDx70gYi7w2ytak8U82H01P1HYnIvr2fEeX7NZpeHdnhM=")
	content := d(t, "oK6DiDHgs7kq5E+kzbbgJ14m5j9NhR0zYa8YY/c=")
	plaintext, err := Decrypt(content,
		WithEncoding(AESGCM),
		WithSalt(salt),
		WithPrivate(privateKey),
...
func TestDecryptWithAES128GCM(t *testing.T) {
	authSecret := d(t, "jas+adg6e7b0fpAjbuKJ5g==")
	senderPublicKey := d(t, "BMVGtV3h5zCXAMmX7b3cbUcnMAtJzzK/Q1Gt3RuV0ogDmfx4LUNEmt80zRHLdrsAVcTYGg2Z1TIP4oUQDix41CY=")
	privateKey := d(t, "bZV1Gqn0ogmzONBaroOTIY7/TesCPu9aIc/A2N1Iz4g=")
...
func TestDecryptWithAES128GCMWithDH(t *testing.T) {
	...
	privateKey := d(t, "yfSYB+/vCEoWklHCG7F99cQ1vRwemFYn87jZc8PHBwU=")
	senderPublicKey := d(t, "BGJXZ4zDA04RfSgTufdauZXcNYbe3oF/yEri5ETSuZLDx70gYi7w2ytak8U82H01P1HYnIvr2fEeX7NZpeHdnhM=")
	content := d(t, "mRGYnIzSJGeZnJ19lgQcfwAAEABBBGJXZ4zDA04RfSgTufdauZXcNYbe3oF/yEri5ETSuZLDx70gYi7w2ytak8U82H01P1HYnIvr2fEeX7NZpeHdnhPF+Ah4eiBMGQcXDvtjM/2s1KUn64dsYvM2ljQ1")
	plaintext, err := Decrypt(content,
		WithEncoding(AES128GCM),
		WithAuthSecret(authSecret),
		WithPrivate(privateKey),
...
func TestDecryptRFC8291Example(t *testing.T) {
	authSecret := d(t, "BTBZMqHH6r4Tts7J_aSIgg")
	privateKey := d(t, "q1dXpw3UpT5VOmu_cf_v6ih07Aems3njxI-JWgLcM94")
	senderPublicKey := d(t, "BP4z9KsN6nGRTbVYI_c7VJSPQTBtkgcy27mlmlMoZIIgDll6e3vCYLocInmYWAmS6TlzAC8wEqKK6PBru3jl7A8")
	content := d(t, "DGv6ra1nlYgDCS1FRnbzlwAAEABBBP4z9KsN6nGRTbVYI_c7VJSPQTBtkgcy27mlmlMoZIIgDll6e3vCYLocInmYWAmS6TlzAC8wEqKK6PBru3jl7A_yl95bQpu6cVPTpK4Mqgkf1CXztLVBSt2Ks3oZwbuwXPXLWyouBWLVWGNWQexSgSxsj_Qulcy4a-fN")
	plaintext, err := Decrypt(content,
		WithEncoding(AES128GCM),
		WithAuthSecret(authSecret),
		WithPrivate(privateKey),
